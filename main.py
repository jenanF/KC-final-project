...
openai.api_key = "sk-zB50esO6xfLMiNbnwP2yT3BlbkFJr9tXRLYqwYIkqqDx8J" #the api link becomes un activie after uploading it on github but you can see on the demo that it works with no problem
